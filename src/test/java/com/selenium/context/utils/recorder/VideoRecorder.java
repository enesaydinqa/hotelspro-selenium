package com.selenium.context.utils.recorder;
...
public class VideoRecorder
{
    ...
    public static void startRecording(String fileName, Boolean start) throws Exception
    {
        if (start)
        {
            File file = new File(System.getProperty("user.dir") + "/src/test/resources/test-scenario-video");
    ...
    public static void stopRecording(Boolean started) throws Exception
    {
        if (started)
        {
            screenRecorder.stop();
